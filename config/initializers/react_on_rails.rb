...
ReactOnRails.configure do |config|
  ...
  # Server rendering only (not for render_component helper) You can configure
  # your pool of JS virtual machines and specify where it should load code: On
  # MRI, use `mini_racer` for the best performance (see
  # [discussion](https://github.com/reactjs/react-rails/pull/290)) On MRI,
  # you'll get a deadlock with `pool_size` > 1 If you're using JRuby, you can
  # increase `pool_size` to have real multi-threaded rendering.
  ...
  # default.js for use by the npm packages react-intl. Be sure this directory
  # exists! config.i18n_dir = Rails.root.join("client", "app", "libs", "i18n")
  #
  # Replace the following line to the location where you keep your client i18n
  # yml files that will source for automatic generation on translations.js &
  # default.js By default(without this option) all yaml files from
  # Rails.root.join("config", "locales") and installed gems are loaded
